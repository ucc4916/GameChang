			...
			<td style="width:70px;height:60px;">
				...
				<p align="center" style="text-align:center;line-height:1.8;">
					<div style = "text-align:center;line-height:1.8" align="center" border="1px";>
						<ul id="ul">
							<%if(((String)session.getAttribute("id"))!=null){ %>
								<li id="div_ul_li">아이디&nbsp</li>
								<li id="div_ul_li">견적가격&nbsp</li>
								<li id="div_ul_li">일급&nbsp</li>
								<li id="div_ul_li">소요날짜&nbsp</li>
								<li id="div_ul_li">시작일&nbsp</li>
								<li id="div_ul_li">종료예상일&nbsp</li> <br>

								<c:forEach var="Dday" items="${Dday}">
								<li id="div_ul_li1">${Dday.id}</li>
								<li id="div_ul_li1">${Dday.cost}원</li>
								<li id="div_ul_li1">
									<a href="#" onclick="window.open('paylist.go?JOB_MONEY=${Dday.pay2}&COMPANY_INFORMATION=${Dday.information}','','top=100px,left=700px,,height=300px,width=300px,menubar=no,resizable=no,status=no,scrollbars=no,titlebar=no,toolbar=no')">${Dday.pay}</a>원</li>
